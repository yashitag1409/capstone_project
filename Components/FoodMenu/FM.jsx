        ...
        <div class="container">
          ...
          <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
            <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
              ...
              <li class="nav-item">
                <a
                  className="d-flex align-items-center text-start mx-3 ms-0 pb-3 anchor "
                  data-bs-toggle="pill"
                  href="#tab-1"
                >
                  <i
              ...
              <li class="nav-item">
                ...
                >
                  <i
                    className="fa fa-hamburger fa-2x "
                    style={{ color: "var(--primary)" }}
                  ></i>

                  <div className="ps-3" style={{ textDecoration: "none" }}>
              ...
              <li class="nav-item">
                ...
                >
                  <i
                    class="fa fa-utensils fa-2x "
                    style={{ color: "var(--primary)" }}
                  ></i>
                  <div class="ps-3" style={{ textDecoration: "none" }}>
